...
public class ThongBaoRepository {
    ...
    private static ThongBaoRepository instance;

    private ThongBaoRepository() {
    }

    public static synchronized ThongBaoRepository getInstance() {
        if (instance == null) {
            instance = new ThongBaoRepository();
        }
        return instance;
    }
