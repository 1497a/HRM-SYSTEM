...
public class ThongTinCaNhanRepository {
    ...
    private static ThongTinCaNhanRepository instance;

    private ThongTinCaNhanRepository() {
    }

    public static synchronized ThongTinCaNhanRepository getInstance() {
        if (instance == null) {
            instance = new ThongTinCaNhanRepository();
        }
        return instance;
    }
