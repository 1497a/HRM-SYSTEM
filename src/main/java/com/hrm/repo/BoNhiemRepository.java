...
public class BoNhiemRepository {
    ...
    private static BoNhiemRepository instance;

    private BoNhiemRepository() {
    }

    public static synchronized BoNhiemRepository getInstance() {
        if (instance == null) {
    ...
    private BoNhiem mapRow(ResultSet rs) throws SQLException {
        ...
        bn.setMaPhongBan(rs.getString("maPhongBan"));
        bn.setMaChucVu(rs.getString("maChucVu"));
    ...
    private void setInsertParams(PreparedStatement ps, BoNhiem bn) throws SQLException {
        ...
        ps.setString(2, bn.getMaPhongBan());
        ps.setString(3, bn.getMaChucVu());
