...
public class RecruitmentRepository {
    ...
    private static RecruitmentRepository instance;

    private RecruitmentRepository() {
    }

    public static synchronized RecruitmentRepository getInstance() {
        if (instance == null) {
            instance = new RecruitmentRepository();
        }
        return instance;
    }
    ...
    private YeuCauTuyenDung mapYeuCau(ResultSet rs) throws SQLException {
        ...
        yc.setMaPhongBan(rs.getString("maPhongBan"));
    ...
    public int insertYeuCau(YeuCauTuyenDung yc) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            ps.setString(1, yc.getMaPhongBan());
